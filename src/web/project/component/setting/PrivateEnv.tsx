...
export function PrivateEnv() {
    ...
    const save_sys_env = async () => {
        ...
        const result = await settingHttp.post(Http_controller_router.setting_sys_option_status_save, {
            type: sys_setting_type.private_sys_env, value: {
                language,
                theme,
                upload_file_ignore
            }
    ...
    return (<React.Fragment>
        <Row>
            ...
            <Column>
                <Dashboard>
                    <CardFull
                        self_title={<span className={" div-row "}><h2>{t("文件夹路径")}</h2> <ActionButton icon={"info"}
                                                                                                           onClick={() => {
                ...
                <Dashboard>
                    ...
                    <ActionButton icon={"info"} onClick={() => {
                        soft_ware_info_click("目录快捷命令")
                    }}
                                  title={"info"}/></span>}
                              titleCom={<div><ActionButton icon={"add"} title={t("添加")} onClick={quick_cmd_add}/>
                    ...
                    <ActionButton icon={"info"} onClick={() => {
                        soft_ware_info_click("文件快捷命令")
                    }}
                                  title={"info"}/></span>}
                              titleCom={<div><ActionButton icon={"add"} title={t("添加")} onClick={file_quick_cmd_add}/>
