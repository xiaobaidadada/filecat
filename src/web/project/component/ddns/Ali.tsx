...
export function Ali(props: any) {
    ...
    const [accesskey_id,setAccesskey_id] = useState("");
    const [accesskey_secret,setAccesskey_secret] = useState("");
    ...
    useEffect( () => {
        (async ()=>{
            ...
            setIpv6s(ipv6list);
            if (data.account) {
                setAccesskey_id((data.account as Tengxun).secretid);
                setAccesskey_secret((data.account as Tengxun).secretkey);
            }
    ...
    const save = async ()=>{
        ...
        data.ips=ips;
        data.account={accesskey_id, accesskey_secret};
        data.isOpen=isOpen;
        ...
        <Row>
            ...
            <Column>
                ...
                <Card title={"说明"} >
                    ...
                    文档地址<i>https://help.aliyun.com/zh/dns/api-alidns-2015-01-09-overview </i>
                </Card>
            </Column>
        </Row>
    </div>
