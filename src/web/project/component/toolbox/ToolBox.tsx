...
export function ToolBox(props) {
    ...
    const menuRots = [{index: 1, name: `ssh${t("代理")}`, rto: "remoteShell/"},{index: 2, name: `${t("浏览器")}${t("代理")}`, rto: "browserproxy/"},{index: 3, name: `rdp${t("代理")}`, rto: "rdp/"},{index: 4, name: t("网络唤醒"), rto: "netwol/"},{index: 5, name: t("时间工具"), rto: "timeutil/"}];
